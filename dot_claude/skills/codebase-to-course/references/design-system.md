...
Code snippets must be **exact copies** from the real codebase -- never modified, trimmed, or simplified. Choose naturally short (5-10 line) sections that illustrate the concept well.
