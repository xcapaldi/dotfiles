...
#+BEGIN_SRC emacs-lisp
  (use-package skeleton
    ...
    (defun skeleton-make-markers ()
      ...
      (save-excursion ;; because we want to go back to start at the end
        (dolist (pos skeleton-positions)
          ...
          (setq skeleton-markers (push (point-marker) skeleton-markers))));; save position as a mark
    ...
    (defun skeleton-next-marker ()
      (interactive)
      (goto-char (marker-position (nth (% skeleton-index (length skeleton-positions)) skeleton-markers)))
      ;; update index
